class Bubble {
    ...
    collision( bubble ) {
        ...
        bubble.pos = p5.Vector.add(bubble.pos, p5.Vector.div(p5.Vector.mult(diff,overLapHalf), dst));   // overlap correction them
    ...
    update() {
        ...
        //if(frameCount % 5 == 0)
        //this.trail.addToTrail(this.pos.x, this.pos.y);
    }
